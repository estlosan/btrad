module.exports = function rsi_heikin(bot, key, length, source_key) {
    if(!bot.lookback[1]) return;
    bot.actualCandle.dif = bot.actualCandle.heikinAshi.close - bot.lookback[0].heikinAshi.close;
